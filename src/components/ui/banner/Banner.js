      ...
      <div className="relative desktop:w-[91.6%] desktop:max-w-[1760px] laptop:max-w-[94%] max-w-[89%] mx-auto desktop:mb-20 tablet:mb-[60px] mb-[30px] rounded-3xl tablet:block hidden">
        <div className="desktop:h-[600px] laptop:h-[480px] tablet:h-[380px]">
          <img
            ...
            src={banner[0].bannerBg}
            alt="img"
          />
        </div>
        <div className="absolute top-0 w-[100%] desktop:h-[600px] laptop:h-[480px] tablet:h-[380px] medium:pt-20 pt-[60px] text-white">
          <h1 className="desktop:w-[600px] medium:w-[460px] w-[250px] mx-auto desktop:mb-[40px] laptop:mb-5 mb-5 desktop:leading-snug desktop:text-4xl medium:leading-snug medium:text-[28px] leading-snug text-xl medium:leading-[120%] leading-6 font-bold text-center tracking-wide">
            {banner[0].title}
          </h1>
      ...
      <div className="relative max-w-[89%] mx-auto mb-[30px] rounded-3xl tablet:hidden block">
        <div>
          <img
            ...
            src={banner[0].bannerBgMobile}
            alt="img"
          />
        </div>
        <div className="absolute top-0 w-[100%] pt-[60px] text-white">
          <h1 className="w-[250px] mx-auto mb-5 text-xl leading-6 font-bold text-center tracking-wide textHeightBanner">
            {banner[0].title}
          </h1>
