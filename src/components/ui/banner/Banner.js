    ...
    />
     ...
     return (
        <div className="desktop:max-w-[91.6%] laptop:max-w-[94%] max-w-[89%] desktop:h-[600px] laptop:h-[480px] h-[380px] mx-auto medium:pt-20 pt-[60px] desktop:mb-20 tablet:mb-[60px]  mb-[30px] rounded-3xl text-white banner-bg">
          <h1 className="desktop:w-[600px] medium:w-[460px] w-[245px] mx-auto mb-[46px] desktop:text-4xl medium:text-[28px] text-xl medium:leading-[120%] leading-6 font-bold text-center tracking-wide">{banner[0].title}</h1>
