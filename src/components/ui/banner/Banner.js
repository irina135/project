...
function Banner() {
  ...
  const newListFilter = listFilter.map((number) => 
    ...
    />
     ...
     return (
      <div>
          <div className="desktop:w-[91.6%] desktop:max-w-[1760px] laptop:max-w-[94%] max-w-[89%] desktop:h-[600px] laptop:h-[480px] h-[380px] mx-auto medium:pt-20 pt-[60px] desktop:mb-20 tablet:mb-[60px]  mb-[30px] rounded-3xl text-white banner-bg">
        ...
        <div className='relative max-w-[89%] mx-auto mb-[30px] rounded-3xl tablet:hidden block'>
          <div className='h-[380px]' >
            <img className='w-[100%] h-[100%]' src={banner[0].bannerBgMobile} alt='img'/>
          </div>
